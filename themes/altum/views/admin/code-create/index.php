    ...
    <div class="card <?= \Altum\Alerts::has_field_errors() ? 'border-danger' : null ?>">
        <div class="card-body">
            ...
            <form action="" method="post" role="form">
                ...
                <div class="form-group">
                    <label for="type"><i class="fa fa-fw fa-sm fa-fingerprint text-muted mr-1"></i> <?= l('admin_codes.main.type') ?></label>
                ...
                <div class="form-group">
                    <label for="code"><i class="fa fa-fw fa-sm fa-tags text-muted mr-1"></i> <?= l('admin_codes.main.code') ?></label>
                ...
                <div id="discount_container" class="form-group">
                    <label for="discount"><i class="fa fa-fw fa-sm fa-percentage text-muted mr-1"></i> <?= l('admin_codes.main.discount') ?></label>
                    <input id="discount" type="number" min="1" max="99" name="discount" class="form-control" value="1" />
                    <small class="form-text text-muted"><?= l('admin_codes.main.discount_help') ?></small>
                </div>

                <div id="days_container" class="form-group">
                    <label for="days"><i class="fa fa-fw fa-sm fa-calendar-day text-muted mr-1"></i> <?= l('admin_codes.main.days') ?></label>
                    <input id="days" type="number" min="1" max="999999" name="days" class="form-control" value="1" />
                    <small class="form-text text-muted"><?= l('admin_codes.main.days_help') ?></small>
                </div>

                <div class="form-group">
                    <label for="quantity"><i class="fa fa-fw fa-sm fa-sort-numeric-up-alt text-muted mr-1"></i> <?= l('admin_codes.main.quantity') ?></label>
                ...
                <div id="bulk_container">
                    <div class="form-group">
                        <label for="amount"><i class="fa fa-fw fa-sm fa-sort-amount-up-alt text-muted mr-1"></i> <?= l('admin_codes.main.amount') ?></label>
                        <input id="amount" type="number" min="1" max="50000" name="amount" class="form-control" value="1" />
                    </div>

                    <div class="form-group">
                        <label for="prefix"><i class="fa fa-fw fa-sm fa-quote-right text-muted mr-1"></i> <?= l('admin_codes.main.prefix') ?></label>

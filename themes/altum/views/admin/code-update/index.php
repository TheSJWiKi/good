    ...
    <div class="card-body">
        ...
        <form action="" method="post" role="form">
            ...
            <div id="days_container" class="form-group">
                ...
                <input id="days" type="number" min="1" max="999999" name="days" class="form-control" value="<?= $data->code->days ?>" />
            ...
            <div class="form-group">
                ...
                <input type="number" min="1" id="quantity" name="quantity" class="form-control" value="<?= $data->code->quantity ?>" />

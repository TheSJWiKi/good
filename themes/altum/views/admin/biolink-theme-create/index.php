    ...
    <div class="card-body">
        ...
        <form action="" method="post" role="form" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <select id="biolink_background_type" name="biolink_background_type" class="form-control">
            ...
            <div class="form-group">
                ...
                <select id="biolink_font" name="biolink_font" class="form-control">
            ...
            <div class="form-group">
                ...
                <select id="biolink_block_border_radius" name="biolink_block_border_radius" class="form-control">
            ...
            <div class="form-group">
                ...
                <select id="biolink_block_border_style" name="biolink_block_border_style" class="form-control">

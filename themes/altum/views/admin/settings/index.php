        ...
        <div class="card d-none d-xl-flex">
            <div class="card-body">
                <div class="nav flex-column nav-pills" role="tablist" aria-orientation="vertical">
                    ...
                    <?php if(\Altum\Plugin::is_active('email-signatures')): ?>
                        <a class="nav-link <?= $data->method == 'signatures' ? 'active' : null ?>" href="<?= url('admin/settings/signatures') ?>"><i class="fa fa-fw fa-sm fa-file-signature mr-1"></i> <?= l('admin_settings.signatures.tab') ?></a>
                    <?php endif ?>
                    <?php if(\Altum\Plugin::is_active('ai-writer')): ?>
                        <a class="nav-link <?= $data->method == 'ai_writer' ? 'active' : null ?>" href="<?= url('admin/settings/ai-writer') ?>"><i class="fa fa-fw fa-sm fa-robot mr-1"></i> <?= l('admin_settings.ai_writer.tab') ?></a>
                    <?php endif ?>
